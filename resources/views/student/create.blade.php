...
@csrf
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" name="gender"  id="lastname" 
				   placeholder="请输性别">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control"  name="class" id="lastname" 
				   placeholder="请输入班级">
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control"  name="grade" id="lastname" 
				   placeholder="请输入成绩">
		</div>
	</div>
